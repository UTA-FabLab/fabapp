...
<div id="page-wrapper">
    ...
    <div class="row">
    <?php   
    if (mysqli_num_rows($mysqli->query(" SELECT *
                                       FROM `wait_queue`
                                       WHERE `valid`='Y' "))>0) {?>
        <!-- Wait Queue -->
        <div class="row">
                                    ...
                                    do {
                                        ...
                                        <thead>
                                                <tr class="tablerow">
                                                    ...
                                                    <?php if ($staff && ($staff->getRoleID() >= $sv['LvlOfStaff'])) { ?> <th><i class="far fa-flag"></i> Alerts</th><?php } ?>
                                                    <?php if ($staff && ($staff->getRoleID() >= $sv['LvlOfStaff'])) { ?> <th><i class="fa fa-times"></i> Remove</th><?php } ?>
                                                </tr>
                                        </thead>
                                        <tbody>
                                            <?php 
