...
<div id="page-wrapper">
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="far fa-calendar-check fa-fw"></i> Replies
                </div>
                                            ...
                                            case 1: //By
                                                if($staffIcon = $mysqli->query("
                                                    ...
                                                    if($staffIcon->num_rows > 0){
                                                        ...
                                                        echo "<td align='center' style='padding: 15px'><i class='" . $staffIcon['icon'] . " fa-lg'></i></td>";
                                                    } else
    ...
    <div class="row">
        ...
        <div class="alert alert-danger" role = "alert" id="errordiv" style="display:none;"><p id="errormessage"></p></div>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fas fa-ticket-alt fa-fw"></i> Update Ticket
                </div>
